...
The goal is to convert raw healthcare data into **actionable insights** using **Snowflake SQL**, **Power BI**, and **Power Query**.
...
- Performed age group-wise segmentation for demographic analysis  
